<template>
  <lay-out>
    <div class="wrap">
      <!-- 头部背景 -->
      <top-image imgUrl="http://cdn.lululuting.com/c0621470-8000-11ea-8994-617ff2232874?imageslim">
      </top-image>
        ...
        <div class="row">
          <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9">
            <el-card>
              ...
              <div v-if="!isEmpty">
                <!-- 这里传入的item有问题 -->
                <article-list-item :article="item" v-for="item in searchArticleList" :key="item.id"></article-list-item>
              </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    watch(() => route.query.searchVal, () => {
      store.dispatch("getSearchArticleList", {searchVal: route.query.searchVal, size: searchSize.value}).then(res => {
      ...
      const {appearMore} = useAppearMore(isEmpty, searchArticleList, searchSize)
    ...
    //   }
    // }
    const onLoadMore = useLoadMore(searchArticleList, "getSearchArticleList",searchArticleCount, isMore, {searchVal: route.query.searchVal, size: searchSize})
